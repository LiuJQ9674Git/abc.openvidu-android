...
public class CustomHttpClient {
    ...
    public CustomHttpClient(String baseUrl, String basicAuth) {
        ...
        //Basic T1BFTlZJRFVBUFA6TVlfU0VDUkVU
        try {
            ...
            this.client = new OkHttpClient.Builder().sslSocketFactory(sslSocketFactory,
                    new X509TrustManager() {
                @Override
                public void checkClientTrusted(X509Certificate[] chain, String authType)
                        throws CertificateException {
    ...
    public void httpCall(String url, String method, String contentType, RequestBody body,
        ...
        Request request = new Request.Builder()
                ...
                .header("Authorization", this.basicAuth).
                        header("Content-Type", contentType).method(method, body)
                .build();
